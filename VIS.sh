	...
	then
		...
		then 	
			...
			then
				...
				if find ~/Desktop/VIS/Paises/ -name *.isl -exec sed -i -e 's/anthony/'"$USER"'/g' {} \; && find ~/Desktop/VIS/Codigo/ -name VIS.py -exec sed -i -e 's/Escritorio/Desktop/g' {} \; && find ~/Desktop/ -name VIS.desktop -exec sed -i -e 's/anthony/'"$USER"'/g' {} \;
				then
